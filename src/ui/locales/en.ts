...
export const en = {
    ...
    YES_KEEP_ACCOUNT: "Yes, keep my account",
    NO_STILL_DELETE_ACCOUNT: "No, I still want to delete my account",
    SCHEDULED_FOR_DELETION: "Your account is scheduled for deletion. If you change your mind, you can cancel account deletion in your account settings.",
    ACCOUNT_DELETION_CANCELLED: "Account deletion cancelled successfully.",
    DELETE_ALL_INTERACTIONS: (entityType, interactionType) => `Delete all ${interactionType}s for ${entityType}s`,
    DELETE_ALL_INTERACTIONS_SURE: (entityType, interactionType) => `Are you sure you want to delete all ${interactionType}s for ${entityType}s? This action cannot be undone.`,
    INTERACTIONS_DELETED: (entityType, interactionType) => `Deleted all ${interactionType}s for ${entityType}s`,
    ...
    NOTIFS_TRACK_DELETED: "Track deleted notifications",
    ...
    FREE: "Free",
    RENEWS_IN: time => `Renews ${time}`,
    CANCELLED_TO: date => `Cancelled to ${date}`,
    ...
    PEOPLE_YOU_FOLLOW_FOLLOW: "people you follow follow this user",
    PERSON_YOU_FOLLOW_FOLLOWS: "person you follow follows this user",
    FOLLOWS_YOU_KNOW: "People you know",
    ...
    TRACK_ADDED_TO_ALBUMS: "Track added to album(s)",
    TRACK_REMOVED_FROM_ALBUMS: "Track removed from album(s)",
    PLAYLIST_CREATED: "Playlist created",
    PLAYLIST_DELETED: "Playlist deleted",
    TRACK_ADDED_TO_PLAYLISTS: "Track added to playlist(s)",
    TRACK_REMOVED_FROM_PLAYLISTS: "Track removed from playlist(s)",
    ALBUM_ADDED_TO_PLAYLISTS: "Album added to playlist(s)",
    ...
    STREAMING_EARNINGS: "Streaming earnings",
    SALE_EARNINGS: "Sale earnings",
    ...
    ROYALTIES_THIS_MONTH: "This month",
    ROYALTIES_AVAILABLE: "Available to pay",
    ARTIST: "Artist",
    AMOUNT: "Amount",
    ...
    FAILED_CHECKOUT_ERROR: error => `Checkout failed: ${error}`,
    ...
    QUEUE_ALL: "Queue all",
    UNQUEUE_ALL: "Unqueue all",
    LIKE_ALL: "Like all",
    UNLIKE_ALL: "Unlike all",
    REPOST_ALL: "Repost all",
    UNREPOST_ALL: "Unrepost all",
    UNQUEUE: "Unqueue",
    QUEUE: "Queue",
    ...
    MINIMUM_ALBUM_PRICE_USD: "Minimum album price in USD (0 = sum of track prices)",
    ...
    PROFILE_TRACKS: name => `Tracks by ${name}`,
    PROFILE_REPOSTS: name => `Reposts by ${name}`,
    ...
    MFA_ENABLED_ENTER_CODE: "You have two-factor authentication enabled. Please enter the code for the method you selected to continue.",
    ...
    PLEASE_SELECT_USER_TYPE: "Please select what describes you best.",
    LISTENER: "Listener",
    LABEL: "Label",
    ADD_YOUR_ARTIST_LINKS: "Add links to your artist profiles on other services so fans can find you everywhere.",
    SKIP: "Skip",
    CONTINUE: "Continue",
    ...
    DISCOGRAPHY_DESCRIPTION: "Import your releases from other platforms. All imported tracks and albums will be private.",
    DISCOGRAPHY_FETCHING: "Fetching releases...",
    DISCOGRAPHY_IMPORTING: "Importing releases...",
    NO_PLATFORMS_CONFIGURED: "Add links to your profiles on other platforms in your account settings and configure the corresponding API keys on the server to enable import.",
    IMPORT: "Import",
    IMPORTED: "Imported",
    RELEASES: "releases",
    ...
    ANSWER_CAN_USE_WITHOUT_SUB: "Yes, you can. However, the features are very limited and streaming quality will be limited to the lowest quality (audible artifacts). However, you can still buy songs and download them.",
    ...
    LIKES: "Likes",
    ADD_TRACK: "Add Track",
    ADD_TRACK_TO_TITLE: title => `Add track to ${title}`,
    ...
    FAILED_UPLOADING_IMAGE: "Failed to upload image",
    ...
    PROCESSED_N_OF_TOTAL: (processed, total, currentId) => `Processed ${processed} of ${total} (current: ${currentId})`,
    ERROR_TRACK_ID: (id, error) => `Error processing track ID ${id}: ${error}`,
    SKIPPED_MISSING_FILES: id => `Skipped missing files for track ID: ${id}`,
    CRITICAL_ERROR: err => `Critical error occurred: ${err}`,
    ...
    TAX_INFO: "Tax Info",
    TAX_INFO_REQUIRED_FOR_PAYOUT: "Tax info is required before requesting a payout.",
    FULL_NAME: "Full name",
    TAX_NUMBER: "Tax number",
    COUNTRY_CODE: "Country (ISO 3166 A3)",
    ...
    REASON_ABUSE: "Abuse",
    REASON_HATESPEECH: "Hate Speech",
    REASON_HEAVY_SWEARING: "Heavy Swearing",
    REASON_ADVERTISING: "Advertising",
    REASON_BOT: "Bot",
    REASON_DOXXING: "Doxxing",
    REASON_FAKE_NEWS: "Fake News",
    REASON_OTHER: "Other",
    ...
    STRIPE_ACCOUNT_READY: "Your Stripe account is ready to receive payments",
    VERIFY_NOW: "Verify now",
    STRIPE_ONBOARDING_PENDING: "Account setup pending — complete your Stripe onboarding",
    STRIPE_ONBOARDING_COMPLETE: "Stripe account setup complete",
    STRIPE_ONBOARDING_FAILED: "Failed to start Stripe onboarding",
    CONNECT_STRIPE_ACCOUNT: "Connect Stripe account",
    OPENING_ONBOARDING: "Opening onboarding...",
    ...
    PAYOUT_FAILED: "Payout request failed. Please try again.",

...
export const en = {
    ...
    DELETE_ALL_INTERACTIONS: (entityType, interactionType) => `Delete all ${interactionType} for ${entityType}`,
    DELETE_ALL_INTERACTIONS_SURE: (entityType, interactionType) => `Are you sure you want to delete all ${interactionType} for ${entityType}? This action cannot be undone.`,
    INTERACTIONS_DELETED: (entityType, interactionType) => `Deleted ${interactionType}s for ${entityType}`,

...
export class AuthTemplates {
    static registrationLoginBox() {
        ...
        > = {
            ...
            "logging-in": AuthTemplates.loggingInBox,
            "mfa-select": AuthTemplates.mfaSelection,
            "mfa-request": AuthTemplates.mfaRequest,
            "verify-mfa": AuthTemplates.mfaVerify,
            complete: AuthTemplates.completeBox,
            "reset-password": AuthTemplates.resetPasswordBox,
            "password-reset": AuthTemplates.enterNewPasswordBox,
            "password-reset-requested": AuthTemplates.passwordResetRequestedBox,
            "verify-email": AuthTemplates.verifyEmailBox,
        };
        ...
        const template = signal(AuthTemplates.templatedLandingPageBox(pageMap, history, step, templateMap, step.value, user));
        step.subscribe((newStep: keyof typeof templateMap) => {
            ...
            template.value = AuthTemplates.templatedLandingPageBox(pageMap, history, step, templateMap, newStep, user);
        });
    ...
    static completeBox() {
        ...
        return AuthTemplates.waitingBox(t("COMPLETE"), t("REDIRECTING"));
    }
    ...
    static registeringBox(step: Signal<string>, user: Signal<AuthData>) {
        ...
        return AuthTemplates.waitingBox(t("REGISTERING"), t("PLEASE_WAIT"));
    }
    ...
    static loggingInBox(step: Signal<string>, user: Signal<AuthData>) {
        ...
        return AuthTemplates.waitingBox(t("LOGGING_IN"), t("PLEASE_WAIT"));
    }
        ...
        return create("div")
            ...
            .children(
                ...
                create("div")
                    .classes("flex-v")
                    .children(
                        AuthTemplates.passwordInput(password, user),
                        input<string>({
    ...
    static checkEmailBox(step: Signal<string>, user: Signal<AuthData>) {
        ...
        return AuthTemplates.waitingBox(t("CHECKING_EMAIL"), t("PLEASE_WAIT"));
    }
